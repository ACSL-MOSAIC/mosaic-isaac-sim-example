...
All the environments are registered in the `mosaic_isaacsim_example` extension. They start
...
import mosaic_isaacsim_example.tasks  # noqa: F401


def main():
    """Print all environments registered in `mosaic_isaacsim_example` extension."""
